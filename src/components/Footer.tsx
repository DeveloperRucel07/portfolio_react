    ...
    <footer className='flex justify-between items-center w-full p-2 flex-col-reverse md:flex-row shadow-[0_-4px_8px_rgba(0,0,0,0.12)]'>
      <section className="flex sm:justify-between items-center w-full md:w-[70%] flex-col sm:flex-row gap-6 p-4">
        <div className='flex flex-col items-center justify-center'>
          ...
          <p className='lowercase'>{t("footer.role")}</p>
        </div>
        <div className='flex flex-col items-center justify-center'>
          ...
          <div className='flex gap-2 text-primary flex-col md:flex-row'>
            <Link to="/legal-notice" className='text-md font-medium hover:text-secondary focus:underline focus:font-bold focus:text-secondary'>{t("footer.legacy")}</Link>
            <Link to="/privacy-policy" className='text-md font-medium hover:text-secondary focus:underline focus:font-bold focus:text-secondary'>{t("footer.privacy")}</Link>
          </div>
        </div>
      </section>
